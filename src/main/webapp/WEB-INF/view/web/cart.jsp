                        ...
                        <table class="table table-bordered text-center mb-0">
                            ...
                            <tbody class="align-middle">
                             <c:forEach var="item" items="${cartItems}" varStatus="status">
                                <tr>
                                    <td class="align-middle"><img src="<c:url value='/template/web/img/user-logos/images.png'/>" alt="" style="width: 50px;">
                                        </td>
                                        ...
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                            <div class="input-group-btn">
                                             <form action = "<c:url value='/cart/update' />"  method ="get">
                                                ...
                                                <button type = "submit" class="btn btn-sm btn-primary btn-minus" onclick="decreaseQuantity(${status.index})" id="DecreaseQuantityBtn" >
                                                    <i class="fa fa-minus"></i>
                                                </button>
                                              </form>
                                            </div>
                                            <input type="text"
                                                class="form-control form-control-sm bg-secondary text-center" id="quantity-${status.index}" value="${item.quantity}">
                                            <div class="input-group-btn" >
                                                <form action = "<c:url value='/cart/update' />"  method ="get">
                                                <input type ="hidden" name = "quantity" value = ${item.quantity+1}>
                                                 <input type ="hidden" name = "productId" value = ${item.productId}>

                                                <button type = "submit" class="btn btn-sm btn-primary btn-plus" onclick="increaseQuantity(${status.index})" id="IncreaseQuantityBtn">
